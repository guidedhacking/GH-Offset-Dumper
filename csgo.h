...
constexpr ptrdiff_t dwEntityList = 0x4D3B6AC;
constexpr ptrdiff_t dwForceAttack = 0x316CD54;
constexpr ptrdiff_t dwForceAttack2 = 0x316CD60;
constexpr ptrdiff_t dwForceBackward = 0x316CDA8;
constexpr ptrdiff_t dwForceForward = 0x316CDB4;
constexpr ptrdiff_t dwForceJump = 0x51DEE98;
constexpr ptrdiff_t dwForceLeft = 0x316CDCC;
constexpr ptrdiff_t dwForceRight = 0x316CDC0;
constexpr ptrdiff_t dwGameDir = 0x62F4F0;
constexpr ptrdiff_t dwGameRulesProxy = 0x525217C;
constexpr ptrdiff_t dwGetAllClasses = 0xD4DC9C;
constexpr ptrdiff_t dwGlobalVars = 0x588AC8;
constexpr ptrdiff_t dwGlowObjectManager = 0x527CED0;
constexpr ptrdiff_t dwInput = 0x5186848;
constexpr ptrdiff_t dwInterfaceLinkList = 0x8F3B74;
...
constexpr ptrdiff_t dwPlayerResource = 0x316B0EC;
constexpr ptrdiff_t dwRadarBase = 0x517040C;
...
constexpr ptrdiff_t dwViewMatrix = 0x4D2D0C4;
constexpr ptrdiff_t dwWeaponTable = 0x518730C;
...
constexpr ptrdiff_t dwbSendPackets = 0xD32BA;
...
constexpr ptrdiff_t m_pitchClassPtr = 0xE10E0056;
...
constexpr ptrdiff_t find_hud_element = 0x51A7B5B0;
...
constexpr ptrdiff_t m_fFlags = 0x40;
...
constexpr ptrdiff_t m_iCrosshairId = 0x1854;
